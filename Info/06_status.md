...
- [x] Добавлен обработчик прерываний EXTI9_5 для тачскрина
- [x] Реализован вывод сообщения в консоль при получении прерывания от тачскрина (если ENABLE_TOUCH_DEBUG=1)
- [x] Обновлен файл состояния проекта
- [x] Диагностика проблемы с логами в прерывании: logger сделан interrupt-safe, добавлен GPIO toggle для отладки
